...
function lazyImage(args) {
  ...
  var image = ['<span itemprop="image" itemscope itemtype="https://schema.org/ImageObject"><img itemprop="url image" src="/image/loading.gif" data-original="' + src + '" class="full-image"'];
